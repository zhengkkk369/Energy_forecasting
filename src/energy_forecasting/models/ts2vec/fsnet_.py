...
class SamePadConv(nn.Module):
    ...
    def fw_chunks(self):
        ...
        if self.trigger == 1:
            ...
            try:
                ...
                raise RuntimeError("FSNet numerical instability")
    ...
    def forward(self, x):
        conv_out = F.conv1d(x, self.conv.weight, padding=self.padding, dilation=self.dilation, bias=self.bias)
        return conv_out
